...
We dont need to sign CLA yet!

## When to follow this process

You should consider using this process if you intend to make "substantial"
changes to ReactX or its documentation. Some examples that would benefit
from an RFC are:
...
Some changes do not require an RFC:
  ...
  - Additions only likely to be _noticed by_ other implementors-of-ReactX,
  invisible to users-of-ReactX.

## What the process is

In short, to get a major feature added to ReactX, one usually first gets
the RFC merged into the RFC repo as a markdown file. At that point the RFC
is 'active' and may be implemented with the goal of eventual inclusion
into ReactX.

* Fork the RFC repo http://github.com/reactx/rfcs
...
feature as a pull request to the other repos. Becoming 'active' is not a rubber
...
**ReactX's RFC process owes its inspiration to the [https://github.com/reactjs/rfcs], [Yarn RFC process], [Rust RFC process], and [Ember RFC process]**
